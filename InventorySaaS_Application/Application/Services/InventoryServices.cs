    ...
    public class WarehouseService
    {
        ...
        public async Task<List<WarehouseDto>> GetAllAsync()
        {
            return await _context.Warehouses
                .Where(w => w.TenantId == _currentUser.TenantId && w.Status == "Active")
        ...
        public async Task<WarehouseDto?> UpdateAsync(Guid warehouseId, CreateWarehouseDto dto)
        {
            var warehouse = await _context.Warehouses
                .FirstOrDefaultAsync(w =>
                    w.WarehouseId == warehouseId &&
        ...
        public async Task<bool> DeleteAsync(Guid warehouseId)
        {
            ...
            // Soft delete — Inventory and StockTransfer both have a Restrict FK
            // on WarehouseId, so a hard delete fails once any stock/transfer
            // history exists for this warehouse.
